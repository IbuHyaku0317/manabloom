...
export default function PrivacyPolicy() {
  return <main className="legal-page">
    ...
    <article className="legal-card">
      ...
      <section>
        <h2>5. 広告・解析・追跡</h2>
        <p>本アプリには、楽天アフィリエイトの広告リンクが含まれています。利用者がリンクを経由して商品を購入した場合、運営者が紹介料を受け取ることがあります。</p>
        <p>本アプリは、広告SDK、行動解析SDKおよび利用者を追跡する仕組みを組み込んでいません。広告リンクを表示しただけで、端末内の学習データが楽天へ送信されることはありません。</p>
        <p>広告リンクをタップすると楽天の外部サイトへ移動します。移動後の情報の取り扱いには、<a href="https://privacy.rakuten.co.jp/" target="_blank" rel="noopener noreferrer">楽天グループの個人情報保護方針</a>その他同社が定める規約が適用されます。将来、広告・解析・追跡の仕組みを変更する場合は、本ポリシーとApp Store上のプライバシー情報を更新します。</p>
      </section>
      ...
      <footer>制定日：2026年8月12日<br />最終改定日：2026年8月14日</footer>
    </article>
  </main>;
}
